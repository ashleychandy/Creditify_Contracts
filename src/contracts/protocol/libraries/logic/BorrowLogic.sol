...
library BorrowLogic {
    ...
    function executeBorrow(
        ...
        ValidationLogic.validateHFAndLtv(reservesData, reservesList, userConfig, params.onBehalfOf, params.oracle);
            ...
            if (onBehalfOfConfig.isUsingAsCollateral(reserve.id)) {
                ...
                if (onBehalfOfConfig.isBorrowingAny()) {
                    ValidationLogic.validateHealthFactor(
                        reservesData, reservesList, onBehalfOfConfig, params.user, params.oracle
                    );
                }
            }
        } else {
