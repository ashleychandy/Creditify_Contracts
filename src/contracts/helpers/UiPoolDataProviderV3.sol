...
contract UiPoolDataProviderV3 is IUiPoolDataProviderV3 {
        ...
        returns (AggregatedReserveData[] memory, BaseCurrencyInfo memory)
    {
        ...
        IPool pool = IPool(provider.getPool());
        CreditifyProtocolDataProvider poolDataProvider = CreditifyProtocolDataProvider(provider.getPoolDataProvider());
        ...
        for (uint256 i = 0; i < reserves.length; i++) {
            ...
            try IDefaultInterestRateStrategyV2(reserveData.interestRateStrategyAddress).getInterestRateData(
