...
import {
    CreditifyV3ConfigEngine,
    ICreditifyV3ConfigEngine,
    CapsEngine,
    BorrowEngine,
    CollateralEngine,
    RateEngine,
    PriceFeedEngine,
    ListingEngine
} from "../../../contracts/extensions/v3-config-engine/CreditifyV3ConfigEngine.sol";
...
contract CreditifyV3HelpersProcedureOne {
    function _deployConfigEngine(
        ...
        ICreditifyV3ConfigEngine.EngineLibraries memory engineLibraries = ICreditifyV3ConfigEngine.EngineLibraries({
        ...
        ICreditifyV3ConfigEngine.EngineConstants memory engineConstants = ICreditifyV3ConfigEngine.EngineConstants({
            pool: IPool(pool),
        ...
        configEngineReport.configEngine =
            address(new CreditifyV3ConfigEngine(aTokenImpl, vTokenImpl, engineConstants, engineLibraries));
