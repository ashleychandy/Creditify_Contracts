...
contract MetadataReporter is IMetadataReporter {
    ...
    function writeJsonReportMarket(MarketReport memory report) external {
        ...
        vm.serializeString(jsonReport, "creditify-v3-factory-commit", factoryV3Commit);
        vm.serializeString(jsonReport, "creditify-v3-factory-branch", factoryV3Branch);
        ...
        vm.serializeAddress(jsonReport, "creditifyOracle", report.creditifyOracle);
